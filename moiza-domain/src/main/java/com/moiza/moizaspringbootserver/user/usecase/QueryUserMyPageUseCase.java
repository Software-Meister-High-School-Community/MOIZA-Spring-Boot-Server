...
import com.moiza.moizaspringbootserver.feed.spi.feed.QueryFeedCountSpi;
...
public class QueryUserMyPageUseCase implements QueryUserMyPageApi {
    ...
    private final QueryFeedCountSpi queryFeedSqi;
    ...
    public MyPageResponse execute() {
        ...
        Long feedCount = queryFeedSqi.getUserFeeCount(user);
